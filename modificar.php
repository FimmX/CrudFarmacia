...
function volver()
{
	 ...
	 if (confirm("¿Seguro desea Salir ?")) {
			document.editeichon.action = "index.html";
			document.editeichon.submit();
			}
}
function validar(){
...
<form name="editeichon" action="modifica.php" method="POST" class="justify-content-center w-50 container">
